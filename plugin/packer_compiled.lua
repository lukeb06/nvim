...
_G.packer_plugins = {
  ...
  ["key-analyzer.nvim"] = {
    loaded = true,
    path = "/Users/lukebarrier/.local/share/nvim/site/pack/packer/start/key-analyzer.nvim",
  ...
  ["lspkind.nvim"] = {
    loaded = true,
    path = "/Users/lukebarrier/.local/share/nvim/site/pack/packer/start/lspkind.nvim",
  ...
  ["vim-be-good"] = {
    loaded = true,
    path = "/Users/lukebarrier/.local/share/nvim/site/pack/packer/start/vim-be-good",
  ...
  volt = {
    loaded = true,
    path = "/Users/lukebarrier/.local/share/nvim/site/pack/packer/start/volt",
